export const USERS_MESSAGES = {
  ...
  PASSWORD_MUST_BE_STRONG:
    'Password must be 6-50 characters long and contain at least 1 lowercase letter, 1 uppercase letter, 1 numeric digit, and 1 special character',
  CONFIRM_PASSWORD_IS_REQUIRED: 'Confirm password is required',
  CONFIRM_PASSWORD_MUST_BE_A_STRING: 'Confirm password must be a string',
  CONFIRM_PASSWORD_LENGTH_MUST_BE_FROM_6_TO_50: 'Confirm password length must be from 6 to 50',
  CONFIRM_PASSWORD_MUST_BE_STRONG:
    'Confirm password must be 6-50 characters long and contain at least 1 lowercase letter, 1 uppercase letter, 1 numeric digit, and 1 special character',
  ...
  FORGOT_PASSWORD_TOKEN_INVALID_OR_EXPIRED: 'Forgot password token invalid or expired',
  ...
  USERNAME_INVALID:
    'Username must be 4-15 characters long and can only contain letters, numbers and underscores, not only numbers',
