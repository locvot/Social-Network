...
//Muon dung async await trong handler express thi phai co try catch
//Neu khong thi dung wrapRequestHandler
      ...
      limit: {
        ...
        custom: {
          options: async (value, { req }) => {
            ...
            if (num > 100 || num < 1) {
              throw new Error(TWEETS_MESSAGES.LIMIT_MUST_BE_LESS_THAN_100_AND_GREATER_THAN_1)
            }
            return true
          }
        }
